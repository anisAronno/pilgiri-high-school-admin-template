                ...
                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="card">
                        <div class="card-header flex-column align-items-start pb-0">
                            ...
                            <h2 class="font-weight-bolder mt-1">50</h2>
                            <p class="card-text">Assigned Orders</p>
                        </div>
                        <div class="mb-5"></div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="card">
                        <div class="card-header flex-column align-items-start pb-0">
                            ...
                            <h2 class="font-weight-bolder mt-1">Tk. 15000</h2>
...
{{--                </div>--}}
                ...
                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="card">
                        <div class="card-header flex-column align-items-start pb-0">
                            ...
                            <h2 class="font-weight-bolder mt-1">10</h2>
                            <p class="card-text">Scheduled Deliveries</p>
                        </div>
                        <div class="mb-5"></div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-header flex-column align-items-start pb-0">
                            ...
                            <div class="col-sm-10 mt-1">
                                <p class="font-weight-bolder">Cash Collection</p>
                                <table width="100%">
                                    <tr>
                                        <td class="font-weight-bolder">Collect</td>
                                        <td>:</td>
                                        <td align="right">10000</td>
                                    </tr>
                                    <tr>
                                        <td class="font-weight-bolder">Settle</td>
                                        <td>:</td>
            ...
            <h4 class="card-text text-center mt-2"> Assigned Order's Location in Map</h4>
