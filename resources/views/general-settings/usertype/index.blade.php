    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">User Type</h2>
                    ...
                    {{--<ul class="nav nav-pills m-1" role="tablist">
                        <li class="nav-item">
                            <a
                                ...
                                aria-selected="true"
                            >
                                <i data-feather="command"></i><span class="d-none d-sm-block">Aleshamart</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a
                                ...
                                aria-selected="false"
                            >
                                <i data-feather="command"></i><span class="d-none d-sm-block">Evaly</span>
                            </a>
                        </li>
                        --}}{{--<li class="nav-item">
                            <a
                                ...
                                aria-selected="false"
                            >
                                <i data-feather="command"></i><span class="d-none d-sm-block">Daraz</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a
                                ...
                                aria-selected="false"
                            >
                                <i data-feather="command"></i><span class="d-none d-sm-block">Chaldal</span>
                            </a>
                        </li>--}}{{--
                    </ul>--}}
                    <!--Search Form -->
