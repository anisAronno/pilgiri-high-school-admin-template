            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body mt-2">
                        <form action="{{ route('vehicle_type.store') }}" method="POST" enctype="multipart/form-data" class="dt_adv_search" >
                        @csrf
                            <div class="row">
                                <div class="col-12">
                                        ...
                                        @foreach($getResponse->data as $response)
                                           <tr>
                                                ...
                                                <td class="text-nowrap">
                                                    ...
                                                    <a href="{{ route('vehicle_type.destroy',$response->id) }}"><i data-feather='trash-2'></i></a>
                                                </td>
                                                <td>{{ $response->name }}</td>
                                                ...
                                                aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                  <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                      <form action="{{ route('vehicle_type.update', $response->id) }}" method="post" enctype="multipart/form-data" files="true">
                                    					@csrf
